...
namespace BizShop.Api.Migrations
{
    ...
    [Migration("20230321215648_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BizShop.Shared.Domain.Country", b =>
                {
            ...
            modelBuilder.Entity("BizShop.Shared.Domain.Employee", b =>
                {
            ...
            modelBuilder.Entity("BizShop.Shared.Domain.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BizShop.Shared.Domain.Employee", b =>
                {
                    b.HasOne("BizShop.Shared.Domain.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BizShop.Shared.Domain.JobCategory", "JobCategory")
                        .WithMany()
